    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white p-2 sm:p-4 font-mono overflow-x-hidden pb-24">
      <div className="max-w-7xl mx-auto mt-4 px-2">
        ...
        <button
          ...
          className="fixed bottom-44 right-6 w-14 h-14 bg-gradient-to-br from-violet-900 to-fuchsia-800 rounded-full shadow-[0_0_18px_rgba(168,85,247,0.45)] flex items-center justify-center transition-all duration-200 hover:scale-110 hover:brightness-110 hover:shadow-[0_0_26px_rgba(217,70,239,0.65)] z-50"
        >
        ...
        {showFloatingFilter && (
          <>
            <div className="fixed inset-0 bg-transparent z-40" onClick={() => setShowFloatingFilter(false)} />
            <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-br from-slate-900 via-purple-900 to-fuchsia-900 rounded-t-3xl shadow-2xl border-t border-white/10 z-50 p-6 max-h-[50vh]" style={{animation: "slideUp 0.3s ease-out"}}>
