...
export default function PublicView() {
  ...
  <h1 className="w-full max-w-full text-center select-none text-[1rem] sm:text-[1.3rem] font-semibold tracking-[0.12em] sm:tracking-[0.16em] drop-shadow-[0_2px_4px_rgba(0,0,0,0.7)] mb-3 leading-tight">
