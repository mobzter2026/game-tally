    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {recentGames.length === 0 ? (
        ...
        recentGames.map(game => (
          <div key={game.id} className="rounded-xl p-3 shadow-[0_4px_8px_rgba(0,0,0,0.35),inset_0_2px_6px_rgba(255,255,255,0.2)] bg-gradient-to-b from-purple-950/60 to-purple-900/95"> <div className="text-slate-300 text-base font-bold mb-2">
