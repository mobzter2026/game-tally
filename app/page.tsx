                    ...
                    <tbody>
                      {playerStats.length === 0 ? (
                        ...
                        playerStats.map((player, idx) => (
                          <tr key={player.player} className={`border-b border-slate-700/50 ${idx >= playerStats.length - 3 ? 'bg-yellow-900/10' : (idx < 3 ? 'bg-purple-900/15' : '')}`}>
                  ...
                  <tbody>
                    {rungTeamStats.length === 0 ? (
                      ...
                      rungTeamStats.map((team, idx) => (
                        <tr key={team.team} className={`border-b border-slate-700/50 ${idx >= playerStats.length - 3 ? 'bg-yellow-900/10' : (idx < 3 ? 'bg-purple-900/15' : '')}`}>
