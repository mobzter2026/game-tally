    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white p-2 sm:p-4 font-mono overflow-x-hidden pb-24">
      <div className="max-w-7xl mx-auto mt-4 px-2">
        ...
        <div className="mb-6 flex justify-center">
          <div className="bg-slate-840/90 rounded-xl p-4 max-w-md w-full">
        ...
        {activeTab === 'individual' && (
          <>
            {hallView !== 'none' ? (
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  {INDIVIDUAL_GAMES.map(gameType => {
                    ...
                    return (
                      <div key={gameType} className="bg-slate-840/90 rounded-xl shadow-2xl overflow-hidden">
              ...
              <div className="bg-slate-840/90 rounded-xl shadow-2xl overflow-hidden mb-8">
            ...
            {hallView === 'none' && (
              <div className="bg-slate-840/90 rounded-xl p-6 mb-8">
	...
	<button
        ...
        {showFloatingFilter && (
          <>
            ...
            <div className="fixed bottom-0 left-0 right-0 bg-slate-840/90 rounded-t-3xl shadow-2xl z-50 p-6 max-h-[50vh] border-t-2 border-fuchsia-500" style={{animation: "slideUp 0.3s ease-out"}}>
